...
```
##  パッケージを 'C:/Users/KAREN/Documents/R/win-library/4.1' 中にインストールします 
##  ('lib' が指定されていないため)
```
...
## 	C:\Users\KAREN\AppData\Local\Temp\RtmpWouqfq\downloaded_packages
```
...
```
## [1] "C:/Users/KAREN/Desktop/BIS15W2022_karen-kyutoku/lab1"
```
