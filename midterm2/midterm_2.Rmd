...
```
The highest average life expectancy: Andorra
The lowest average life expectancy: Central African Republic
...
life_exp_long %>% 
  ...
  labs(title = "Improvement in Life Expectancy 1920-2020",
       ...
       fill= "country")
```
Some events that may have caused this change are industrial developement and economic improvement in the countries.
