...
A vector in R is a type of data structure that is ordered and consists of elements, usually of the same class.

2. What is a data matrix in R?  
A data matrix is a collection of vectors which are organized in columns and rows.
